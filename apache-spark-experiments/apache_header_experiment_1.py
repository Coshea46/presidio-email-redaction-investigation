...
INPUT_DIR = '/home/conor/Desktop/phishing-internship-2026/presidio-based-approach/presidio-email-redaction-investigation/apache-spark-benign-samples/extracted-mime-headers/split-sample-encoding-and-not/never-contained-encoding'
BASE_OUTPUT_DIR = '/home/conor/Desktop/phishing-internship-2026/presidio-based-approach/presidio-email-redaction-investigation/presidio-output/mime-header-experiments/apache-spark-benign/experiment-1'
...
with open(OUTPUT_CSV_PATH,mode='w',encoding='utf-8',newline='') as f:
    ...
    for header_file in os.listdir(INPUT_DIR):
        ...
        with open(header_file_path, mode='r', encoding='utf-8', newline='') as input_file:
